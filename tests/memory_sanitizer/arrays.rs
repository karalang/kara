...
/// B-2026-09-22-11 (sanitizer twin) — the BUILTIN-ENVELOPE spelling of B-2026-09-22-10.
...
"#,
        ...
        "asan_array_param_into_named_seeded_envelope_local_stays_with_caller",
    );
}
...
/// any rebind.
#[test]
fn asan_array_param_rebound_in_the_callee_is_a_view_of_the_callers_array() {
    assert_clean_asan_run(
        r#"struct R { id: i64, s: String }
impl Drop for R { fn drop(mut ref self) { println(f"  d{self.id}") } }
...
#[test]
fn asan_local_array_returned_on_some_exits_is_dropped_once() {
    assert_clean_asan_run(
        r#"struct R { id: i64, s: String }
impl Drop for R { fn drop(mut ref self) { println(f"  d{self.id}") } }
fn mkr(i: i64) -> R { return R { id: i, s: f"heap-string-longer-than-sso-{i}" } }
...
"#,
        &[
            "loc-t", "  y1", "  d1", "  d2", "loc-f", "  d1", "  d2", "  dies", "  y8", "  d8",
            "  d9", "tailif-t", "  y4", "  d3", "  d4", "tailif-f", "  d3", "  d4", "  y9", "  d8",
            "  d9", "inloop-t", "  y5", "  d5", "  d6", "inloop-f", "  d5", "  d6", "  dies",
            "  y8", "  d8", "  d9", "passed-t", "  y11", "  d11", "  d12", "passed-f", "  c11",
            "  d11", "  d12", "  dies", "  y8", "  d8", "  d9", "ppass-t", "  y20", "  d20",
            "  d21", "ppass-f", "  c20", "  dies", "  d20", "  d21", "  y8", "  d8", "  d9",
            "str-t", "  y30", "str-f", "  y32", "end",
        ],
...
#[test]
fn asan_array_param_pushed_into_a_container_is_freed_once() {
    assert_clean_asan_run(
        r#"struct R { id: i64, s: String }
impl Drop for R { fn drop(mut ref self) { println(f"d{self.id}") } }
fn mkr(i: i64) -> R { return R { id: i, s: f"aaa" } }
...
"#,
        &[
            "loc1", "d1", "d2", "k1", "out", "k2", "n1", "d3", "d4", "ret", "k3 1", "d5", "d6",
            "st1", "d7", "k4", "ins1", "d8", "d9", "k5", "new1", "d10", "d11", "k6", "loc1", "d12",
            "d13", "k7", "two2", "d14", "d15", "d16", "d17", "k8", "meth1", "d18", "d19", "k9",
            "end",
        ],
        "asan_array_param_pushed_into_a_container_is_freed_once",
    );
}
...
#[test]
fn asan_param_pushed_into_a_container_on_some_paths_is_freed_once() {
    assert_clean_asan_run(
        r#"struct R { id: i64, s: String }
impl Drop for R { fn drop(mut ref self) { println(f"d{self.id}") } }
fn mkr(i: i64) -> R { return R { id: i, s: f"aaa" } }
...
"#,
        &[
            "semi1", "d1", "d2", "semi0", "d3", "d4", "k1", "tail1", "d5", "d6", "tail0", "d7",
            "d8", "k2", "arm1", "d9", "d10", "arm0", "d11", "d12", "k3", "els1", "d13", "d14",
            "no", "els0", "d15", "d16", "k4", "nest1", "d17", "d18", "nest0", "d19", "d20", "k5",
            "out1", "out1", "d23", "d24", "k6", "n1", "d21", "d22", "st1", "d25", "st0", "d26",
            "k7", "starm1", "d27", "starm0", "d28", "k8", "marr1", "d29", "d30", "marr0", "d31",
            "d32", "k9", "mst1", "d33", "mst0", "d34", "k10", "mout1", "mout1", "d36", "k11", "m1",
            "d35", "end",
        ],
