...
#[test]
fn asan_rc_promoted_result_and_map_boxes_are_freed_once() {
    assert_clean_asan_run(
...
"#,
        ...
        "asan_rc_promoted_result_and_map_boxes_are_freed_once",
    );
}
...
#[test]
fn asan_if_let_binding_shadowing_a_moved_local_frees_it() {
    assert_clean_asan_run(
...
"#,
        &["1 1", "2 6", "29 29", "29 29", "end"],
        "asan_if_let_binding_shadowing_a_moved_local_frees_it",
    );
}
...
#[test]
fn asan_map_read_after_move_into_an_owner_keeps_its_free() {
    assert_clean_asan_run(
...
"#,
        &["2 2", "2 2", "2 2", "2 2", "2 2", "2 2", "2 2", "end"],
        "asan_map_read_after_move_into_an_owner_keeps_its_free",
    );
}
...
#[test]
fn asan_map_moved_then_read_again_keeps_its_own_table() {
    assert_clean_asan_run(
...
"#,
        &[
            "2 2", "2 2", "2 2", "2 2", "2 1", "2 1", "2 1", "2 1", "4 4", "2 1", "2 1", "end",
        ],
        "asan_map_moved_then_read_again_keeps_its_own_table",
    );
}
...
/// `--interp` was right.
#[test]
fn asan_option_local_handed_out_as_branch_leaf_frees_once() {
    assert_clean_asan_run_min_allocs(
...
"#,
        ...
        "asan_option_local_handed_out_as_branch_leaf_frees_once",
        20,
    );
}
...
#[test]
fn asan_indexed_optres_element_clone_then_unwrap_frees_once() {
    assert_clean_asan_run_min_allocs(
...
"#,
        ...
        "asan_indexed_optres_element_clone_then_unwrap_frees_once",
        10,
    );
}
