...
#[test]
fn test_e2e_borrowed_element_field_copy_matches_interp() {
    let out = run_program(
        r#"
...
#[test]
fn test_e2e_mut_ref_param_alias_writes_reach_caller() {
    let out = run_program(
        r#"
