...
// B-2026-09-24-7 — `let t = r;` over a `mut ref` binding aliases the caller's
// value: a write through `t` reaches it, for a Vec, a String, a struct field,
// a chained alias and a scalar.
#[test]
fn test_mut_ref_param_alias_writes_reach_caller() {
    assert_eq!(
        run(r#"
