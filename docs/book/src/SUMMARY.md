...
- [Structs and Enums](./ch05-structs-and-enums.md)
- [Pattern Matching](./ch06-pattern-matching.md)
...
- [The Effect System](./ch11-effects.md)
- [Ownership Without the Fight](./ch12-ownership.md)
- [Modules and Visibility](./ch13-modules.md)
...
- [Appendix B: Operators and Symbols](./appendix-b-operators.md)
- [Appendix C: Derivable Traits](./appendix-c-derivable-traits.md)
- [Appendix D: Attributes](./appendix-d-attributes.md)
