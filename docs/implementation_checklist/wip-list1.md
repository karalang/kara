...
| C | Typed effect resources + in-memory providers + canonical `get_dashboard` workload (full Parallax demo) | 2026-05-09 | 2026-05-09 | ~150 min | b2aa70a |
