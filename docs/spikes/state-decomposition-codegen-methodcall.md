...
| 2 | cluster 15 `VarTables` — remainder | in progress — next: type-decl tables (19, ~1014 sites, one method collision `struct_field_type_exprs` noted), then rc-elision fn-keyed set (7), `variables` + residual singles | — |
