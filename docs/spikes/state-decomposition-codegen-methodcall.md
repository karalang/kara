...
| 2 | cluster 15 `VarTables` — remainder | in progress — next: fn_* signature tables (15, dry-run clean), then rc-elision fn-keyed set (7), type-decl tables (19), `variables` + residual singles | — |
