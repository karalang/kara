...
| 2 | cluster 15 `VarTables` — remainder | in progress — remaining sub-families measured: heap-env closure tables (12), inline/boxed payload vars (12), aliases/passthrough (8), fn_* signature tables (15), rc-elision fn-keyed set (7), type-decl tables (19), plus `variables` and the residual singles | — |
