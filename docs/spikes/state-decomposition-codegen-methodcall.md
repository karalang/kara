...
| 2 | cluster 15 `VarTables` — remainder | in progress — next: inline/boxed payload vars + aliases (18, dry-run clean), then fn_* signature tables (15), rc-elision fn-keyed set (7), type-decl tables (19), `variables` + residual singles | — |
