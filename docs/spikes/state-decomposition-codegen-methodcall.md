...
| 2 | cluster 15 `VarTables` — remainder | in progress — next: borrow/param-mode locals (11 fields, ~198 sites, dry-run clean), then module-level bindings (~6), `variables` + residual singles | — |
