...
| 2 | cluster 15 `VarTables` — remainder | in progress — next: span-keyed upstream-handoff tables (33 fields, 162 sites, dry-run clean), then `variables` + residual singles | — |
