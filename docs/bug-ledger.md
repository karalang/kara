...
_Generated from `bug-ledger.jsonl` by `scripts/bug-curve.py` — **73 surfaced · 2 open · 71 fixed** (2026-05-20 → 2026-06-14). Do not edit this block by hand; edit the ledger and regenerate._

### Open (2)

| id | date | surface | sev | title | tracker |
|---|---|---|---|---|---|
| B-2026-06-07-5 | 2026-06-07 | codegen | high | Returned borrows (-> ref T): most tiers shipped; Option[ref T]+small tiers+first_word/StringSlice open | phase-7-codegen.md |
...
<details><summary>71 fixed — the regression test is the durable artifact; prose lives in each owning phase tracker</summary>
