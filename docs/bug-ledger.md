...
_Generated from `bug-ledger.jsonl` by `scripts/bug-curve.py` — **78 surfaced · 2 open · 76 fixed** (2026-05-20 → 2026-06-14). Do not edit this block by hand; edit the ledger and regenerate._
...
| B-2026-06-14-20 | 2026-06-14 | codegen | med | 1a401c7b ordered-output: println->write_console blows lean binary-size floor + outdated @fwrite IR test | phase-7-codegen.md |

### Fixed (76)

<details><summary>76 fixed — the regression test is the durable artifact; prose lives in each owning phase tracker</summary>
