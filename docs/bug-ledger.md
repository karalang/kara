...
_Generated from `bug-ledger.jsonl` by `scripts/bug-curve.py` — **80 surfaced · 1 open · 79 fixed** (2026-05-20 → 2026-06-14). Do not edit this block by hand; edit the ledger and regenerate._
...
<details><summary>79 fixed — the regression test is the durable artifact; prose lives in each owning phase tracker</summary>
