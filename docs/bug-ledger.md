...
_Generated from `bug-ledger.jsonl` by `scripts/bug-curve.py` — **73 surfaced · 1 open · 72 fixed** (2026-05-20 → 2026-06-14). Do not edit this block by hand; edit the ledger and regenerate._
...
<details><summary>72 fixed — the regression test is the durable artifact; prose lives in each owning phase tracker</summary>
