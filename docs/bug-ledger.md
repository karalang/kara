...
_Generated from `bug-ledger.jsonl` by `scripts/bug-curve.py` — **1254 surfaced · 5 open · 1234 fixed · 5 wontfix** (2026-05-20 → 2026-08-17). Do not edit this block by hand; edit the ledger and regenerate._
...
| B-2026-08-16-14 | 2026-08-16 | other | low | A 31-bit LCG shifted by 16 gives 15-bit keys, so `% 1000000` never fires — 'shuffled-uniform' benchmark data has 32768 distinct keys | kara-katas bench data generators |
